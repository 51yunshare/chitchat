...
public class FacebookTokenGranter extends AbstractTokenGranter {
    ...
    public FacebookTokenGranter(AuthorizationServerTokenServices tokenServices, ClientDetailsService clientDetailsService, OAuth2RequestFactory requestFactory, AuthenticationManager authenticationManager) {
    ...
    protected OAuth2Authentication getOAuth2Authentication(ClientDetails client, TokenRequest tokenRequest) {
        ...
        Authentication userAuth = new FacebookAuthenticationToken(code, state); // 未认证状态
