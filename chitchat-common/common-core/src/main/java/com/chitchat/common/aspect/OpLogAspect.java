package com.chitchat.common.aspect;

import com.alibaba.fastjson.JSON;
import com.chitchat.common.annotation.OpLog;
...
public class OpLogAspect {
    ...
    protected void handleLog(final JoinPoint joinPoint, OpLog controllerLog, final Exception e, Object jsonResult) {
        try {
            ...
            operaLog.setOperUrl(ServletUtils.getRequest().getRequestURI());
     ...
     * @throws Exception
     */
//    public void getControllerMethodDescription(JoinPoint joinPoint, OpLog log, SysOperLog operaLog, Object jsonResult) throws Exception {
//        // 设置action动作
...
//            operaLog.setJsonResult(StringUtils.substring(JSON.toJSONString(jsonResult), 0, 2000));
//        }
//    }
