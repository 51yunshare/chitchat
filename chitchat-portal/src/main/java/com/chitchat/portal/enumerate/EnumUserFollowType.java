 ...
 */
public enum EnumUserFollowType implements IntegerValuedEnum {
    用户("用户", 1, "用户"),
    房间("房间", 2, "房间"),
    ...
    //构造方法
    EnumUserFollowType(String name, int index, String description) {
        this.name = name;
        this.index = index;
    ...
    public static List<Map<String, Object>> getMapInfo() {
        ...
        for (EnumUserFollowType type : EnumUserFollowType.values()) {
    ...
    public static String getNameByIndex(Integer index) {
        ...
        for (EnumUserFollowType enumUserSource : values()) {
