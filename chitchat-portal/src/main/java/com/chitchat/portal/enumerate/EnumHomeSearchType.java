 ...
 */
public enum EnumHomeSearchType implements IntegerValuedEnum {
    ROOM("Room", 1, "房间"),
    USER("User", 2, "用户"),
    ...
    //构造方法
    EnumHomeSearchType(String name, int index, String description) {
        this.name = name;
        this.index = index;
    ...
    public static List<Map<String, Object>> getMapInfo() {
        ...
        for (EnumHomeSearchType type : EnumHomeSearchType.values()) {
    ...
    public static String getNameByIndex(Integer index) {
        ...
        for (EnumHomeSearchType enumUserSource : values()) {
