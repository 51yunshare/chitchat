 ...
 */
public enum EnumReportReason implements IntegerValuedEnum {
    我不喜欢这个用户("我不喜欢这个用户", 1, "I don't like it"),
    涉黄("涉黄", 2, "Porn"),
    辱骂("辱骂", 3, "Spam"),
    欺诈("欺诈", 4, "Fraud"),
    暴力("暴力", 5, "Violence"),
    ...
    //构造方法
    EnumReportReason(String name, int index, String description) {
        this.name = name;
        this.index = index;
    ...
    public static List<Map<String, Object>> getMapInfo() {
        ...
        for (EnumReportReason type : EnumReportReason.values()) {
    ...
    public static String getNameByIndex(Integer index) {
        ...
        for (EnumReportReason enumUserSource : values()) {
