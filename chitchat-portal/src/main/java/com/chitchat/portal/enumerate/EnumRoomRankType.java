 ...
 */
public enum EnumRoomRankType implements IntegerValuedEnum {
    日榜("日榜", 1, "贡献日榜"),
    周榜("周榜", 2, "贡献周榜"),
    ...
    //构造方法
    EnumRoomRankType(String name, int index, String description) {
        this.name = name;
        this.index = index;
    ...
    public static List<Map<String, Object>> getMapInfo() {
        ...
        for (EnumRoomRankType type : EnumRoomRankType.values()) {
    ...
    public static String getNameByIndex(Integer index) {
        ...
        for (EnumRoomRankType enumUserSource : values()) {
