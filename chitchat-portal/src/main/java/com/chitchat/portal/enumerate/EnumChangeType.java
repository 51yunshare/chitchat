 ...
 */
public enum EnumChangeType implements IntegerValuedEnum {
    ADD("增加", 0, "增加"),
    REDUCE("减少", 1, "减少"),
    ...
    //构造方法
    EnumChangeType(String name, int index, String description) {
        this.name = name;
        this.index = index;
    ...
    public static List<Map<String, Object>> getMapInfo() {
        ...
        for (EnumChangeType type : EnumChangeType.values()) {
    ...
    public static String getNameByIndex(Integer index) {
        ...
        for (EnumChangeType enumUserSource : values()) {
