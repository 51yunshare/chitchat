 ...
 */
public enum EnumRoomMessageCategory implements IntegerValuedEnum {
    系统消息("系统消息", 1, "系统消息"),
    聊天消息("聊天消息", 2, "聊天消息"),
    ...
    //构造方法
    EnumRoomMessageCategory(String name, int index, String description) {
        this.name = name;
        this.index = index;
    ...
    public static List<Map<String, Object>> getMapInfo() {
        ...
        for (EnumRoomMessageCategory type : EnumRoomMessageCategory.values()) {
    ...
    public static String getNameByIndex(Integer index) {
        ...
        for (EnumRoomMessageCategory enumUserSource : values()) {
