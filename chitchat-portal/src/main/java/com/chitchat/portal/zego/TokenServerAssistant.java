 ...
 *
 * 如果您安装的是 JDK7，可以到 Java Cryptography Extension (JCE) Unlimited Strength Jurisdiction Policy Files 7 下载该文件。
 * 如果您安装的是 JDK8，可以到 Java Cryptography Extension (JCE) Unlimited Strength Jurisdiction Policy Files 8 下载该文件。
 * 下载完成后，解压该文件，得到 local_policy.jar 、US_export_policy.jar 和 readme.txt 文件。
 *
