 ...
 **/
@Data
@ApiModel(value = "后台用户新增请求对象", description = "用户新增对象")
public class SysUserAddRequestDTO implements Serializable {

    private static final long serialVersionUID = 5678588263151072086L;
